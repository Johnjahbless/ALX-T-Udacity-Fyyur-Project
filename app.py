...
def venues():
  ...
  #areas2 = Venue.query.order_by('num_upcoming_shows').all()
  data=[{
    "city": "San Francisco",
    "state": "CA",
    "venues": [{
...
def create_venue_submission():
  ...
  try:
    ...
    venue = Venue(name, city, state, address, phone, genres, facebook_link, image_link, website_link, seeking_talent, seeking_description)
